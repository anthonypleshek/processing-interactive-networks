Sketch for creating interactive networks/graphs using [Processing](http://processing.org) written during a hackathon, so the code is an absolute mess right now.
